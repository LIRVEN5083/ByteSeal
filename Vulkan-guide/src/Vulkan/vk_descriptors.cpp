...
// maxSets - общий лимит на количество сетов layout(set = 0, binding = 0) uniform MyBuffer { ... };
// мы пишем что данные будут кидаться в set = 0, а binding к этому set 1 к примеру"
